...
if ((event.body.toLowerCase() == "🙂") || (event.body.toLowerCase() == "🙃")) {
     return api.sendMessage("mewwww baby", threadID);
   };
...
if ((event.body.toLowerCase() == "💔") || (event.body.toLowerCase() == "💔💔")) {
     return api.sendMessage("আহ কষ্ট হলে একবার baby বলে ডাক", threadID);
   };
...
if ((event.body.toLowerCase() == "মারিয়া") || (event.body.toLowerCase() == "Mahira")) {
  ...
  if ((event.body.toLowerCase() == "@rx jibon") || (event.body.toLowerCase() == "jibon")) {
