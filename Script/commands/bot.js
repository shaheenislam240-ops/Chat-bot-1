...
if ((event.body.toLowerCase() == "ceo?") || (event.body.toLowerCase() == "bot er malik k")) {
...
if ((event.body.toLowerCase() == "arshir ammu") || (event.body.toLowerCase() == "Mahira")) {
...
if ((event.body.toLowerCase() == "arshi") || (event.body.toLowerCase() == "Arshir ammu")) {
   ...
   if ((event.body.toLowerCase() == "😅") || (event.body.toLowerCase() == "...")) {
     return api.sendMessage("️কি গো কলিজা তোমার কি মন খারাপ একবার শুধু baby ডাক🥺", threadID);
   };
