...
𝗔𝗨𝗧𝗢𝗠𝗢𝗗 𝗔𝗟𝗘𝗥𝗧 🚫   ╔════════════════════════════════════╗   ║ ⚠️ 𝗪𝗔𝗥𝗡𝗜𝗡𝗚: Offensive Language Detected   ║ 👤 User: ${userName}   ║ 📄 Message: Contains prohibited words   ║ 🔁 Offense Count: ${count}   ║ 🧹 Action: Please delete/unsend immediately   ╚════════════════════════════════════╝;
...
}; ata modify kore oita add koro er modde oi logic ta use koro 3 bar jodi user bad wardlekhey protom 2 bar alart janabe then 3rd belay kick kore dibe oporer code er kick logic ta use koro
