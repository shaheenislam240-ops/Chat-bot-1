...
module.exports.handleEvent = async function({
	...
	if ((i.resend === true) && l != global.data.botID && ("message_unsend" != e.type && global.logMessage.set(g, {
			msgBody: c,
	...
	return void 0 === d.resend || d.resend == false ? d.resend = true : d.resend = false, await t.setData(n, {
		data: d
